...
class CoreUserRepository extends ServiceEntityRepository
{
     ...
     */
    public function add(CoreUser $entity, bool $flush = true): void
    {
     ...
     * @throws OptimisticLockException
     */
    public function remove(CoreUser $entity, bool $flush = true): void
    {
    ...
    // /**
    //  * @return UnitCrmUserEntity[] Returns an array of UnitCrmUserEntity objects
    //  */
    /*
    ...
    */
    ...
    /*
    public function findOneBySomeField($value): ?UnitCrmUserEntity
    {
        return $this->createQueryBuilder('u')
            ->andWhere('u.exampleField = :val')
            ->setParameter('val', $value)
